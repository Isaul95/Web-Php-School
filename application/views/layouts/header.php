...
<head>
    ...
    <title>Sistema de Ventas | RESTAURANTE XX </title>
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <!-- CUANDO LA BARRA DE OCULTA ALA IZKIERDA mini logo for sidebar mini 50x50 pixels   ISAULLLL    -->
                ...
                <span class="logo-lg"><b> "EL TOLOACHE" </b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"> <?php echo $this->session->userdata("nombres")?></span> <!--- IMPESION variable de session "NOMBRE DE USUARIO" --> 
                            </a>
