...
public function obtenerDatosGnralDelAlumnos($semestre,$licenciatura,$opciones){
    ...
    as alumno, detalles.cuatrimestre as semestre, carrera.carrera_descripcion as carrera_descripcion, carrera.id_carrera, calf.detalle, detalles.opcion, detalles.carrera, detalles.promedio ");
